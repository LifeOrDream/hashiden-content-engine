...
variant, and species agree. Labels and species language are derived locally.
...
Body proportions follow the current body variant and species. Mint and evolution
jobs generate full body first, then use it as the sole PFP reference. Expression
sheets and rare cards require existing canonical art.
