...
- Every product fact must become CONFLICT, STATUS, COMEDY, THREAT, or ACTION. Game events become story beats: "country won the cycle" → "Brazil stole the mine in the final minute."; "HashBeast ascended" → "The pup came back wearing armor and nobody laughed."; "leaderboard flipped" → "America blinked. India did not."
